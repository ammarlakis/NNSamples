...
namespace AForge.Neuro
{
    ...
    /// with activation function. It consists of <see cref="ActivationLayer">activation
    /// layers</see>.</para>
    ///
    ...
    public class ActivationNetwork : Network
    {
        ...
        public ActivationNetwork(IActivationFunction[] functions, int inputsCount, params int[] neuronsCount)
            : base(inputsCount, neuronsCount.Length)
        {
            // create each layer
            for (int i = 0; i < layers.Length; i++)
